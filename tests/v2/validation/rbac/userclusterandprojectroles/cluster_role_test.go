...
func (rb *RBACAdditionalTestSuite) TestClusterOwnerAddsUserAsClusterOwner() {
	...
	errUserRole := users.AddClusterRoleToUser(rb.client, rb.cluster, clusterAdmin, rbac.ClusterOwner.String(), nil)
	...
	errUserRole2 := users.AddClusterRoleToUser(clusterAdminClient, rb.cluster, additionalUser, rbac.ClusterOwner.String(), nil)
...
func (rb *RBACAdditionalTestSuite) TestClusterOwnerAddsClusterMemberAsProjectOwner() {
	...
	errUserRole2 := users.AddClusterRoleToUser(clusterAdminClient, rb.cluster, additionalUser, rbac.ClusterMember.String(), nil)
	require.NoError(rb.T(), errUserRole2)
	additionalUserClient, err = additionalUserClient.ReLogin()
	require.NoError(rb.T(), err)
